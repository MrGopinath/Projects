...
PreparedStatement ps=conn.prepareStatement("select * from addemp where Emp_id='"+id1+"' ");
...
<div class="text-center">
	...
	<a href="#myModal" class="trigger-btn" data-toggle="modal">Click to Add Client</a>
</div>
